...
public class LoggedWordCounterConfiguration extends Configuration {
	...
	public LoggedWordCounterConfiguration(final int threads, final File... input) {
		...
		stateLogger.register(merger);
		stateLogger.register(result);
	}
